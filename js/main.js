...
// new Swiper(선택자, 옵션)
new Swiper('.notice-line .swiper-container', { //new 생성자(클래스)
  direction: 'vertical',
  autoplay: true,
  loop: true
});  
...
let isHidePromotion = false; // 프로모션 영역이 숨겨져 있는 여부
...
function floatingObject(selector, delay, size){ //selector 매개변수
  // gsap.to(요소, 시간, 옵션);
  gsap.to(
    selector, // 선택자
